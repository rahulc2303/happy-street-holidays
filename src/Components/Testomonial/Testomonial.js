...
const testimonial = [
    {
        id: 1,
        name: 'John Doe',
        content: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed aliquam, purus ut scelerisque aliquet, diam libero sollicitudin ligula.',
        avatar: '	https://preview.colorlib.com/theme/travelo/img/testmonial/author.png',
    },
    {
        id: 2,
        name: 'Jane Smith',
        content: 'Ut at mollis nulla. Sed nec quam quam. Maecenas nec nisi auctor, interdum neque id, dignissim tortor.',
        avatar: '	https://preview.colorlib.com/theme/travelo/img/testmonial/author.png',
    },
    {
        id: 3,
                ...
                <div className="relative h-400px">
                    ...
                    <div className="relative ">
                        {testimonial.map((testimonial, index) => (
                            <div
                                key={testimonial.id}
                                className={`absolute w-full transform transition-all duration-300 ${index === activeIndex ? 'opacity-100 ' : 'opacity-0 translate-x-full'
                                    }`}
                            >
